...
class Apple
{
    ...
    Color d_color;
public:
    Apple(const int& size = 1, const Color& color = Color::GREEN)
    {
        d_size = size;
        d_color = color;
    }

    void GrowUp(){apple.size += 1;}
    void ChangeColor(struct Apple* apple){apple.color = RED;}
}
...
string string string string string 
vector (v5) moved from vector (v4):
size of v4: 5
string string string string string 
size of v4: 0
*/